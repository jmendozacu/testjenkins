...
})))->withContext('twig.template_cache_warmer', $this), new \Symfony\Bundle\TwigBundle\TemplateIterator(${($_ = isset($this->services['kernel']) ? $this->services['kernel'] : $this->get('kernel')) && false ?: '_'}, $this->targetDirs[2], array(($this->targetDirs[4].'/pimcore/lib/Pimcore/Install/../Bundle/AdminBundle/Resources/views') => 'PimcoreAdminBundle')));
