...
$instance->registerPlugin(${($_ = isset($this->services['swiftmailer.mailer.pimcore_mailer.plugin.messagelogger']) ? $this->services['swiftmailer.mailer.pimcore_mailer.plugin.messagelogger'] : $this->services['swiftmailer.mailer.pimcore_mailer.plugin.messagelogger'] = new \Swift_Plugins_MessageLogger()) && false ?: '_'});
