...
return $this->services['services_resetter'] = new \Symfony\Component\HttpKernel\DependencyInjection\ServicesResetter(new RewindableGenerator(function () {
    ...
    return 0 + (int) (isset($this->services['profiler'])) + (int) (isset($this->services['validator'])) + (int) (isset($this->services['debug.stopwatch'])) + (int) (isset($this->services['security.token_storage'])) + (int) (isset($this->services['pimcore.cache.core.symfony_adapter.filesystem'])) + (int) (isset($this->services['pimcore.cache.core.symfony_adapter.array']));
}), array('profiler' => 'reset', 'debug.validator' => 'reset', 'debug.stopwatch' => 'reset', 'security.token_storage' => 'setToken', 'pimcore.cache.core.symfony_adapter.filesystem' => 'reset', 'pimcore.cache.core.symfony_adapter.array' => 'reset'));
